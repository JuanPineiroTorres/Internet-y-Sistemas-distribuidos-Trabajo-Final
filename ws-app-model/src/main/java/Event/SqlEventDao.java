...
public interface SqlEventDao {
    ...
    List<Event> findEventByFutureDateWithAttend(Connection connection, LocalDate start, LocalDate finish, int attend) throws InputValidationException;
    void remove(Connection connection, Long eventId)
        throws InstanceNotFoundException;
    void removeCanceledOrAlreadyDone(Connection connection, long eventId) throws InstanceNotFoundException;
