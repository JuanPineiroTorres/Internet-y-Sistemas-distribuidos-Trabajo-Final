...
public interface EventService {
    ...
    List<Event> findEventByFutureDateWithAttend(LocalDate futureDateIn, LocalDate futureDate, int attendance)  throws  InputValidationException;
    void  removeEventCanceledOrAlreadyDone(long eventId) throws InstanceNotFoundException, NotCanceledOrAlreadyDoneEvent;
}
