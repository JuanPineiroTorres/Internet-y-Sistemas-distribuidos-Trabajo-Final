...
import es.udc.ws.app.client.service.exceptions.ClientNotCanceledOrAlreadyDoneEvent;
...
public class JsonToClientExceptionConversor {
    ...
    public static ClientNotCanceledOrAlreadyDoneEvent toClientNotCanceledorAlreadyDoneEvent(JsonNode rootNode){
        Long eventId = rootNode.get("Id").longValue();
        return new ClientNotCanceledOrAlreadyDoneEvent(eventId);
    }
    ...
    public static Exception fromForbiddenErrorCode(InputStream ex) throws ParsingException {
        try {
            ...
            if (rootNode.getNodeType() != JsonNodeType.OBJECT) {
                ...
                } else if(errorType.equals("NotCanceledOrAlreadyDoneEvent")){
                    return toClientNotCanceledorAlreadyDoneEvent(rootNode);
                } else  {
                    throw new ParsingException("Unrecognized error type: " + errorType);
                }
            }
