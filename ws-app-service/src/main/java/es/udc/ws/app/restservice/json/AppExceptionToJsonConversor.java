...
public class AppExceptionToJsonConversor {
    ...
    public static ObjectNode NotCanceledOrAlreadyDoneEvent(NotCanceledOrAlreadyDoneEvent ex){
        ObjectNode exceptionObject = JsonNodeFactory.instance.objectNode();
        exceptionObject.put("errorType","NotCanceledOrAlreadyDoneEvent");
        exceptionObject.put("Id", (ex.getEventId() != null) ? ex.getEventId() : null);
        return  exceptionObject;
    }
}
